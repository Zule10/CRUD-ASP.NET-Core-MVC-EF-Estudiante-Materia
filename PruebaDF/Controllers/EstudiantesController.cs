...
namespace PruebaDF.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(PruebaDfContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EstudianteId,Nombre,Documento,Correo")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteId,Nombre,Documento,Correo")] Estudiante estudiante)
        {
